from exercise_objects import Exercise, Equipment, Muscles, PushOrPull, LOWER_MUSCLES, UpperOrLower
...
EXERCISES = {
    ...
    "Squat": Exercise(
        ...
        {Equipment.none_needed, Equipment.tubed_bands, Equipment.large_looped_bands},
        LOWER_MUSCLES,
        PushOrPull.push
    ),
    ...
    "Standing Glute Kickback": Exercise(
        [
         ...
         "under as you kick your right leg back about 6 inches. Keep your knee straight."
        ],
        {Equipment.mini_looped_bands},
        {Muscles.glutes},
        PushOrPull.push,
    ...
    "Single Arm Press": Exercise(
        ...
        {Equipment.tubed_bands_and_stationary_object},
        {Muscles.abs, Muscles.shoulders, Muscles.chest, Muscles.triceps, Muscles.biceps},
        PushOrPull.push,
    ),
    "Downward Chops": Exercise(
        ...
        {Equipment.tubed_bands_and_stationary_object},
        {
            Muscles.abs, Muscles.back, Muscles.shoulders, Muscles.calves,
            Muscles.biceps, Muscles.glutes, Muscles.quads, Muscles.hamstrings
        },
        PushOrPull.pull,
    ),
    "Pallof Lateral Walk": Exercise(
        ...
        {Equipment.tubed_bands_and_stationary_object},
        {Muscles.shoulders, Muscles.abs, Muscles.quads, Muscles.hamstrings, Muscles.glutes},
        PushOrPull.pull,
    ),
    "Plank": Exercise(
        ["Keep your butt down"],
        {Equipment.none_needed},
        {
            Muscles.abs, Muscles.chest, Muscles.biceps, Muscles.triceps,
            Muscles.quads, Muscles.hamstrings, Muscles.glutes
        },
        PushOrPull.pull,
    ),
    "Lat Pull-down": Exercise(
        ["Bands around wrist. Bring your elbows down, pushing laterally along the sides of the mini band"],
        {Equipment.mini_looped_bands, Equipment.tubed_bands_and_stationary_object},
        {Muscles.back},
        PushOrPull.pull,
    ),
    ...
    "Squat and Overhead Press": Exercise(
        ["Push through your heels."],
        {Equipment.tubed_bands},
        LOWER_MUSCLES | {Muscles.back, Muscles.chest, Muscles.shoulders, Muscles.triceps},
        PushOrPull.push,
    ),
    "Pull-up": Exercise(
...
def print_all_exercises(exercises:dict[str: Exercise]):
    exercise_categories = {cat:[] for cat in [UpperOrLower.upper,UpperOrLower.lower,UpperOrLower.full_body]}
