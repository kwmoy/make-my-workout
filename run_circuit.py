...
from sound_and_wait_helpers import rest_and_introduce_exercise, run_active_exercise, BaseOperations, rest_and_say_words
...
rest_and_say_words(active_time, "Round 1 is complete! One minute until round 2")
run_circuit(my_exercises, active_time, rest_time)
rest_and_say_words(active_time, "Round 2 is complete! One minute until round 3")
run_circuit(my_exercises, active_time, rest_time)
